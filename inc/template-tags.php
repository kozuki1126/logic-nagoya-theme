...
if ( ! function_exists( 'logic_nagoya_posted_on' ) ) :
	 ...
	 */
	function logic_nagoya_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'logic-nagoya' ),
...
if ( ! function_exists( 'logic_nagoya_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function logic_nagoya_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'logic-nagoya' ),
...
if ( ! function_exists( 'logic_nagoya_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function logic_nagoya_entry_footer() {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'logic-nagoya' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'logic-nagoya' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'logic_nagoya_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function logic_nagoya_post_thumbnail() {
