	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => 'logic_nagoya_customize_partial_blogname',
			)
		);
		$wp_customize->selective_refresh->add_partial(
			'blogdescription',
			array(
				...
				'render_callback' => 'logic_nagoya_customize_partial_blogdescription',
			)
		);
	}
}
 ...
 * @return void
 */
function logic_nagoya_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function logic_nagoya_customize_partial_blogdescription() {
